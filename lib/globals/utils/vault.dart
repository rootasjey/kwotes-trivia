...
import "package:kwotes_trivia/types/enums/enum_data_ownership.dart";
import "package:kwotes_trivia/types/enums/enum_language_selection.dart";
import "package:kwotes_trivia/types/enums/enum_search_category.dart";
...
class Vault {
  ...
  Future<EnumLanguageSelection> getLanguage() async {
    ...
    // return EnumLanguageSelection.values[index];
    return EnumLanguageSelection.values[0];
  }
