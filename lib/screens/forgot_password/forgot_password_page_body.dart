...
import "package:kwotes_trivia/screens/forgot_password/forgot_password_page_email_input.dart";
import "package:kwotes_trivia/screens/forgot_password/forgot_password_page_footer.dart";
      ...
      child: Center(
        child: Container(
          ...
          child: Column(
            ...
            ].animate(delay: 75.ms).slideY(begin: 0.2, end: 0.0).fadeIn(),
          ),
        ),
      ),
    );
